...
_C.DATASET.NUM_FOLDS = 5  # For k-fold cross-validation
...
# _C.SOLVER.MAX_EPOCHS_PRETRAIN = 200
...
_C.GAT.NUM_LAYERS = 3
_C.GAT.HIDDEN_DIM = [100,100,100]

_C.GAT.DROPOUT_RATE = 0.3
_C.GAT.TRANS_DROPOUT_RATE = 0.2
_C.GAT.LR_PRETRAIN = 1e-3
_C.GAT.LR = 1e-3  # Learning rate
_C.GAT.WD = 1e-3  # Weight decay
_C.GAT.WEIGHT=[0.5,0.5]


_C.GAT.FINAL_FEAT_SIZES = [600]
...
_C.RESULT.SAVE_MODEL_TMPL = "{dataset_name}_model_[{fold_idx}]_[{feat_size}]_[{seed}].ckpt"
